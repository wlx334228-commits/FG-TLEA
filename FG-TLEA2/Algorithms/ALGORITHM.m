classdef ALGORITHM < handle & matlab.mixin.Heterogeneous
    ...
    methods(Access = protected, Sealed)
        function nofinish = NotTerminated(obj,Population,ulArchive)
            ...
            index = max(1,min(min(num,size(obj.result,1)+1),ceil(num*(obj.pro.ulFE+obj.pro.llFE)/obj.pro.maxFE)));
            obj.result(index,:) = {obj.pro.ulFE,Population};
            ...
            if nofinish == 0
                ...
                ulFE = obj.pro.ulFE;
                llFE = obj.pro.llFE;
                runtime = obj.metric.runtime;
                if isa(obj.pro,'TP1')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP1\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP1\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP1\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP1\',filename],'runtime');
                elseif isa(obj.pro,'TP2')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP2\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP2\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP2\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\TP\TP2\',filename],'runtime');
                elseif isa(obj.pro,'DS1')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS1\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS1\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS1\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS1\',filename],'runtime');
                elseif isa(obj.pro,'DS2')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS2\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS2\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS2\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS2\',filename],'runtime');
                elseif isa(obj.pro,'DS3')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS3\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS3\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS3\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS3\',filename],'runtime');
                elseif isa(obj.pro,'DS4')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS4\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS4\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS4\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS4\',filename],'runtime');
                elseif isa(obj.pro,'DS5')
                    filename = 'Solution_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS5\',filename],'res');
                    filename = 'ULFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS5\',filename],'ulFE');
                    filename = 'LLFE_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS5\',filename],'llFE');
                    filename = 'Runtime_mine.mat';
                    save(['D:\MSE-SWork\明雪-代码\工作一\saveData\DS\DS5\',filename],'runtime');
                end
            end
...
score = mean(all(Population.ulCons<=0,2));
end