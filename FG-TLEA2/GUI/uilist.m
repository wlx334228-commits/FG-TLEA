...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function add(obj,filename,type)
            ...
            item.tip = uibutton(obj.grid,'Text','ss','FontSize',10,'BackgroundColor',color,'FontColor',[1 1 1],'Tooltip',Comment,'ButtonPushedFcn',@obj.cb_callmenu);
