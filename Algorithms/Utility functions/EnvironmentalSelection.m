...
%--------------------------------------------------------------------------
    ...
    Objs = [Population.ulObjs,Population.llObjs];
    Cons = [Population.ulCons,Population.llCons];
    ...
    NextObjs = [Population(Next).ulObjs,Population(Next).llObjs];
    LastObjs = [Population(Last).ulObjs,Population(Last).llObjs];
    Choose = LastSelection(NextObjs,LastObjs,N-sum(Next),Z,Zmin);
